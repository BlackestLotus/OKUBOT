...
from OKUbot import BOT_USERNAME, OWNER_ID, OWNER_USERNAME
from OKUbot.config import get_str_key
from OKUbot.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from OKUbot.function.pluginhelpers import fetch
from OKUbot.services.pyrogram import pbot
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot.", url=f"t.me/{BOT_USERNAME}"),
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/OKU_prince_bot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[OKUbot✨](https://github.com/prince301102/OKUbot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER](t.me/{OWNER_USERNAME})
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
