...
if ENV:
    ...
    USERNAME_BOT = os.environ.get("USERNAME_BOT", "@OrangKurangUpayaBot")
    ...
    from OKUbot.config import Development as Config
...
from OKUbot.modules.helper_funcs.handlers import (
