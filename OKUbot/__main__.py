...
from OKUbot.modules import ALL_MODULES
from OKUbot.modules.helper_funcs.chat_status import is_user_admin
from OKUbot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("OKUbot.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
          ...
          update.effective_message.reply_video(
                OKU_IMG, caption= "I'm awake already!\n<b>Haven't slept since:</b> <code>{}</code>".format(
                uptime
            ),
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=f""" ℹ️ I'm {BOT_NAME}, a powerful group management bot built to help you manage your group easily. Developed and created by Blackest Lotus.
                 ...
                 \n_This bot is licensed under the GNU General Public License v3.0_
                 Here is the [💾Repository](https://github.com/BlackestLotus/OrangKurangUpaya).
                 If you have any question about our bot, please do let us know at [SUPPORT CHAT](https://t.me/{SUPPORT_CHAT}).""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Greetings to our fellow handicaps. This is the Official Master Bot for *Orang Kurang Upaya*
                 \nHere is the [Source Code](https://github.com/BlackestLotus/OrangKurangUpaya) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
