...
from OKUbot import telethn as GogoAnime
...
async def gogo(event):
 ...
 if not args:
  return await event.respond("Your Query should be in This format: /search <space> Name of the Anime you want to Search.")
