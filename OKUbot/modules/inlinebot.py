# Copyright (C) 2021 TheHamkerCat & TeamOKUbot
...
from OKUbot import BOT_USERNAME, USERNAME_BOT
from OKUbot.config import get_str_key
from OKUbot.function.inlinehelper import *
from OKUbot.function.pluginhelpers import fetch, json_prettify
from OKUbot.services.pyrogram import pbot as app
...
__MODULE__ = "Inline"
__HELP__ = f"""
 ==>> **INLINE BOT SERVICE OF** @OKU_PRINCE_BOT <<==

`I'm more efficient when added as group admin. By the way these commands can be used by anyone in a group via inline.`

   >> Using <<
@OKU_PRINCE_BOT [command] [query]
