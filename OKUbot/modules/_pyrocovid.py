from OKUbot import pbot as app
from OKUbot.pyrogramee.errors import capture_err
from OKUbot.pyrogramee.json_prettify import json_prettify
from OKUbot.pyrogramee.fetch import fetch
