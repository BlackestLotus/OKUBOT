...
import requests
import re
from OKUbot import pbot as LYCIA
...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("Aco", "OKU")
        result = result.replace("Eliza", "OKU")
        result = result.replace("Hi~", "Hello Friend I Am @OKU_PRINCE_BOT")
...
async def redaura(client, message):
    ...
    result = result.replace('"}', "")
    result = result.replace("Aco", "OKU")
    result = result.replace("Eliza", "@OKU_prince_bot")
    result = result.replace("Hi~", "Hello Friend I Am @OKU_PRINCE_BOT")
    result = result.replace("My dear great botmaster, Lyciabot Team.", "Made By @PRINCE_3011")
    result = result.replace("Have the control right.", "My Father Is @PRINCEBOTS")
    result = result.replace("I was created by Lyciabot Team.", "I was created by @PRINCEBOTS.")
