...
import OKUbot.modules.sql.global_bans_sql as sql
from OKUbot.modules.sql.users_sql import get_user_com_chats
from OKUbot import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from OKUbot.modules.helper_funcs.misc import send_to_list
