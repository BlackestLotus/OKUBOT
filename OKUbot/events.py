...
from OKUbot import MONGO_DB_URI
from OKUbot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import OKUbot.events

        path = Path(f"OKUbot/modules/{shortname}.py")
        name = "OKUbot.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["OKUbot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "OKUbot/modules/*.py"
